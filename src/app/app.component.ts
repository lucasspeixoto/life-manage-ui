...
@Component({
  ...
  <section>
    <div class="bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl">
      <div>
        <span class="inline-flex items-center justify-center p-2 bg-primary rounded-md shadow-lg">
...
export class AppComponent implements OnInit {
  ...
  public themeTooltipText = computed(() => this.isDark() ? 'Mudar para tema claro' : 'Mudar para tema escuro')
